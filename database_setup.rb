...
# Make the tables
DATABASE.execute("CREATE TABLE IF NOT EXISTS assignments (id INTEGER PRIMARY KEY, date TEXT, name TEXT UNIQUE, description TEXT, github TEXT, blog TEXT DEFAULT none, student_id INTEGER DEFAULT 0);")
